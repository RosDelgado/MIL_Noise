...
# plot(thres,Diff.F1.score.bag[[1]],type="l")
# plot(thres,Diff.Accuracy.bag[[1]],type="l")
# plot(thres,Diff.BA.bag[[1]],type="l")
...
plot(
  ...
  type = "l", 
  col = "blue",             # Color de la línea principal
  lwd = 1,                  # Grosor de la línea
  xlab = "Threshold",       # Etiqueta del eje X
  ylab = " ",  # Etiqueta del eje Y
  main = "Mean increment in F1-score using c-rule across the folds"  # Título del gráfico
)

# Agregar una línea roja discontinua en y = 0
...
plot(
  ...
  xlab = "Threshold",       # Etiqueta del eje X
  ylab = " ",  # Etiqueta del eje Y
  main = "Mean increment in F1-score using c-rule (except fold 3)"  # Título del gráfico
)
...
ggplot(df.F1.score, aes(x = thres, y = value, color = fold)) +
  geom_line(size = 0.4) +                            # Líneas de cada fold
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") +  # Línea roja
...
plot(
  ...
  xlab = "Threshold",       # Etiqueta del eje X
  ylab = " ",  # Etiqueta del eje Y
  main = "Mean increment in Accuracy using c-rule across the folds"  # Título del gráfico
)
...
plot(
  ...
  xlab = "Threshold",       # Etiqueta del eje X
  ylab = " ",  # Etiqueta del eje Y
  main = "Mean increment in Accuracy using c-rule (except fold 3)"  # Título del gráfico
)
...
plot(
  ...
  xlab = "Threshold",       # Etiqueta del eje X
  ylab = " ",  # Etiqueta del eje Y
  main = "Mean increment in BA using c-rule across the folds"  # Título del gráfico
)
...
plot(
  ...
  xlab = "Threshold",       # Etiqueta del eje X
  ylab = " ",  # Etiqueta del eje Y
  main = "Mean increment in BA using c-rule (except fold 3)"  # Título del gráfico
)
...
ggplot(df.BA, aes(x = thres, y = value, color = fold)) +
  geom_line(size = 0.5) +                            # Líneas de cada fold
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") +  # Línea roja
